...
//     defaultIDs = defaultSample.map(data => data.otu_ids)
//     defaultValues = defaultSample.map(data => data.sample_values)
//     defaultLabels = defaultSample.map(data => data.otu_labels)
...
d3.json("samples.json").then(function(data) {
    ...
    defaultValues = defaultSample.sample_values;
    defaultLabels = defaultSample.otu_labels;
